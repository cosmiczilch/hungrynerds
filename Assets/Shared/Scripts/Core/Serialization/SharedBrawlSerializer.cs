...
public class SharedBrawlSerializer {
    ...
    public static void Serialize(Stream stream, object obj) {
        string json = SharedBrawlSerializer.Serialize(obj);
    ...
    public static void DeserializeIntoObject(Stream stream, object obj) {
        ...
        SharedBrawlSerializer.DeserializeIntoObject(json, obj);
    }

    public static object DeserializeNonGeneric(Type type, Stream stream) {
        StreamReader sr = new StreamReader(stream, Encoding.UTF8);
        string json = sr.ReadToEnd();
        return SharedBrawlSerializer.DeserializeNonGeneric(type, json);
    }
    ...
    public static T Deserialize<T>(Stream stream) {
        StreamReader sr = new StreamReader(stream, Encoding.UTF8);
        string json = sr.ReadToEnd();
        return SharedBrawlSerializer.Deserialize<T>(json);
    }
